...
public class GameManager : MonoBehaviour {
    ...
    // This method increment the number of living enemies.
    public static void AddEnemy()
    {
        numEnemiesAlive++;
    }

    // This method increment the number of living allies.
    ...
    {
        GameObject.Find("WinSpawner").GetComponent<WinningManager>().ShowUI();
    }
